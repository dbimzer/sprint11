...
namespace {
    ...
    void TestNull() {
        ...
        const Node node = LoadJSON("null"s).GetRoot(); //mistake
        assert(node.IsNull());
    ...
    void TestMap() {
        ...
        //Node dict_node1{ Dict{{"42"s, 42}, {"4.2"s, 4.2}, {"true"s, true}, {"string"s, "string"s}, {"[]"s, Array{}}} };
        //assert(LoadJSON("{\"42\":42,\"4.2\":4.2,\"true\":true,\"string\":\"string\",\"[]\":[]}"s).GetRoot() == dict_node1);
    }
    ...
    void Benchmark() {
        ...
        const auto doc = json::Load(strm); //error
